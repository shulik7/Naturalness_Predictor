...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python mark_natural_molecules.py <npatlas_file> <chembl_file>")
        sys.exit(1)
    
    npatlas_file = Path(sys.argv[1])
    chembl_file = Path(sys.argv[2])
    ...
    output_file = "../data/marked_ChEMBL_small_molecules.tsv.gz"
